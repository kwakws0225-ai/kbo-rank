...
HEADERS = {"User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/124.0 Safari/537.36", "Referer": "https://www.koreabaseball.com/"}
...
def crawl_kbo_team_rank(save_csv: bool = True) -> pd.DataFrame:
    ...
    if save_csv:
        ...
        print("저장 완료: " + stamped_name)
        print("최신본 갱신: " + latest_name)
